...
from app.domain.b2_experiment_manifest import build_b2_experiment_manifest
from app.domain.candidate_a_packet import build_candidate_a_packet
from app.domain.nc01_packet import build_nc01_packet


def packet_for(run_id: str):
    if run_id.startswith("B2-A-"):
        return build_candidate_a_packet()
    if run_id.startswith("B2-NC01-"):
        return build_nc01_packet()
...
def main() -> None:
    ...
    manifest = build_b2_experiment_manifest()
