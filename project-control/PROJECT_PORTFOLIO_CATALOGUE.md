...
## Purpose
This is the canonical short-form registry of current AJ Project OS project ideas. The numeric IDs now reflect the current portfolio priority order for the ranked projects, with lower-priority projects placed later. AJ's personal LLM remains a special personal-mastery track and is deliberately kept near the front because it is active and personally important, not because it must compete as an FYP candidate.
...
|---|---:|---|
| P001 | P007 | Intelligent Coding Examination Platform |
| P002 | P003 | AJ's Educational Language Model From Scratch |
| P003 | P011 | Geopolitical Risk to Economic Impact Forecasting and Warning System |
| P004 | P012 | Internet Compression and Optimization Proxy System |
| P005 | P014 | Automated Log Analysis and Root-Cause Assistance Tool |
| P006 | P002 | AI-Powered Virtual Classroom and Personal Learning World |
| P007 | P004 | School Point & Digital Economy System |
| P008 | P013 | StartupMatch: Founder–Investor Matching Platform |
| P009 | P006 | Personal Screen Memory System |
| P010 | P005 | Intelligent Online Chess Platform |
| P011 | P001 | Source-Grounded AI Defense Simulator |
| P012 | P009 | Interactive AI Virtual Audience |
...
**Status:** ACTIVE PORTFOLIO RESEARCH — HIGHEST RANKED GENERAL/FYP CANDIDATE.
...
**Status:** HIGH-INTEREST RESEARCH CANDIDATE.

### Project P004 — Internet Compression and Optimization Proxy System
**Previous ID:** P012  
**Class:** GENERAL / PRODUCT SYSTEM

An application-level proxy intended to reduce transferred data and improve perceived responsiveness in bandwidth-constrained environments through safe, measurable optimization. Modern HTTPS/TLS, HTTP/2, HTTP/3/QUIC, CDNs, content encoding and end-to-end encryption are first-order constraints.

**Status:** STRONG SYSTEMS RESEARCH CANDIDATE; MODERN PROTOCOL CONSTRAINTS MAY FORCE REFRAME.

### Project P005 — Automated Log Analysis and Root-Cause Assistance Tool
**Previous ID:** P014  
**Class:** GENERAL / PRODUCT SYSTEM

A lightweight utility for parsing heterogeneous logs, extracting anomalous events, correlating evidence and assisting operators in identifying plausible root causes. Research must distinguish parsing, anomaly detection, event correlation, causal inference, retrieval and LLM explanation.

**Status:** STRONG ENGINEERING/FYP CANDIDATE; AIOPS PRIOR ART EXPECTED TO BE CROWDED.
...
**Status:** CONDITIONAL GO / PARKED FOR PORTFOLIO COMPARISON. IMPLEMENTATION INTENTIONALLY NOT STARTED.

### Project P007 — School Point & Digital Economy System
**Previous ID:** P004  
**Class:** GENERAL / PRODUCT SYSTEM

A governed school points/reward economy tied to selected achievements. Research must address motivation, fairness, incentive design, fraud/abuse, accessibility, governance and privacy.
...
P001, P003, P004 and P005 are currently the highest-ranked uncompleted general/FYP research candidates. P006 already has a conditional-go theory and is parked for comparison. P002 is a special personal-mastery project: it remains active regardless of its FYP ranking. Lower numeric IDs generally indicate higher current portfolio priority, but evidence may justify future reordering through an explicit migration decision.
